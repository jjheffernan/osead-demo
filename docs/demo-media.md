...
These SVGs are original demo artwork for the OSEAD template. Before a production launch, replace them with license-cleared photos (owned shoots, purchased rights, or clearly attributed public-domain / Unsplash assets) and keep alts specific to each frame.

Optional next pass: optimize JPEG/WebP under ~200KB each when swapping SVG demos for photography.
